...
The FAIR-QMM can be used as a FAIRness assessment tool independently and/or as a translator between other FAIRness assessment tools or models. It can be used to determine the FAIRness requirements, identify gaps, and develop a roadmap for meeting the requirements, as depicted in the figure below.
